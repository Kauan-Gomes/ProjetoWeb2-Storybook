...
const cores = [
    {
        corPrimaria: "bg-black/30",
        corHover: "bg-black/10",
    },
    {
        corPrimaria: "bg-red-400",
        corHover: "bg-red-500",
    },
    {
    ...
    {
        corPrimaria: "bg-green-400",
        corHover: "bg-green-600",
    },
    {
        corPrimaria: "bg-blue-400",
        corHover: "bg-blue-600",
    },
    {
        corPrimaria: "bg-violet-400",
        corHover: "bg-violet-600",
    },
]


const SpanCores = ({ setCorModal }) => {
    return (
        <div className="flex gap-3 mx-auto">
            ...
            <span onClick={() => setCorModal('bg-white')} className={`border cursor-pointer shadow bg-white 'bg-transparent'} h-5 w-5 rounded-full relative`}>
